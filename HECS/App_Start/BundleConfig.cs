    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/fancybox").Include(
                ...
                "~/Scripts/fancybox/source/helper/jquery.fancybox-buttons.js",
                "~/Scripts/fancybox/source/helper/jquery.fancybox-media.js",
                "~/Scripts/fancybox/source/helper/jquery.fancybox-thumbs.js"
                ));
